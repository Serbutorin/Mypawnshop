...
if( ! defined( 'WPCDT_VERSION' ) ) {
	define( 'WPCDT_VERSION', '1.5' ); // Version of plugin
}
...
if( ! defined( 'WPCDT_PRO_LINK' ) ) {
	define( 'WPCDT_PRO_LINK', 'https://www.wponlinesupport.com/wp-plugin/countdown-timer-ultimate/?utm_source=WP&utm_medium=Countdown&utm_campaign=Features-PRO' ); // Pro Plugin link
}
